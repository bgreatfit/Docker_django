...
--
-- Host: 172.18.0.2
-- Generation Time: May 20, 2019 at 01:41 AM
...
(1, 'pbkdf2_sha256$120000$kc0u7zuBRqIr$ByPFH12tKJOQkmZqxC1QJIs/Aue8YYTiBfJa8RzWA6g=', '2019-05-19 14:43:37.345361', 1, 'admin', '', '', '', 1, 1, '2019-05-16 02:56:07.857190'),
(2, 'pbkdf2_sha256$120000$pSvyG4DFXzON$uUgw8UkjYXl93fW0O7WCzab/qcNicihtc5v89zLM0OU=', NULL, 0, 'mikegreat', '', '', '', 0, 1, '2019-05-16 06:26:13.000000'),
...
('274523b04ee446b78c187d1a9636f3c7', 'ssztvhbkj', '2019-05-16', 'o', 2, NULL),
...
--
ALTER TABLE `webpage`
  ADD CONSTRAINT `polls_webpage_topic_id_94a8a70e_fk_polls_topic_id` FOREIGN KEY (`topic_id`) REFERENCES `topic` (`id`);
COMMIT;
